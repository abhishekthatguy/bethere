...
export default class HeaderComp extends Component {
    ...
    render() {
        ...
        return (
            <Header className={isScrolled ? "header-blue" : 'header-blue'}>
                <div className="container" style={{display: 'flex', justifyContent: 'space-between'}}>
                    ...
                    <div style={{display: 'flex'}}>
                        <div className={'search-root'} >
                            ...
                            /> */}
                            <Input  placeholder="Search Youtube" prefix={<SearchOutlined />} />
                    ...
                    <div style={{display: 'flex'}}>
                        ...
                        <Dropdown overlay={menu} placement="bottomRight">
                             <Button className="account-btn" type="primary" shape="circle" icon={<UserOutlined />} size={22} />
                        </Dropdown>
                        </div>
                </div>
                <Drawer
